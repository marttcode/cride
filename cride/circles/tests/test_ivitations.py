...
class InvitationsManagerTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create(
            first_name='Martin',
            last_name='Carlos',
            email='martin@itzacatepec.edu.mx',
            username='martin',
            password='admin123'
        )
        self.circle = Circle.objects.create(
            name='Carrera de ISC',
            slug_name='isc',
            about='Grupo oficial del ITZ de la carrera de ISC',
            verified=True
        )
...
class MemberInvitationsAPITestCase(APITestCase):
    ...
    def test_invitation_creation(self):
        ...
        self.assertEqual(invitations.count(), self.membership.remaining_invitation)
